...
export default function Stage3GuarantorNominee() {
  ...
  const handleNext = async () => {
    ...
    if (!validatePerson(nominee1, 'Nominee 1')) {
      return
    }
    ...
    if (nominee2 && isPersonPartiallyFilled(nominee2)) {
      if (!validatePerson(nominee2, 'Nominee 2')) {
        return
      }
    }
    ...
    if (!validatePerson(guarantor1, 'Guarantor 1')) {
      return
    }
    ...
    if (guarantor2 && isPersonPartiallyFilled(guarantor2)) {
      if (!validatePerson(guarantor2, 'Guarantor 2')) {
        return
      }
    }
