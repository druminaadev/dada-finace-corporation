...
function generateDocHTML(docKey: string, loan: any, customer: any): string {
  ...
  const base = `<html><head><style>body{font-family:Arial,sans-serif;padding:40px;color:#1a1a1a;font-size:13px}h1{color:#1E40AF;border-bottom:2px solid #1E40AF;padding-bottom:8px;font-size:18px}h2{color:#374151;font-size:14px;margin-top:20px}table{width:100%;border-collapse:collapse;margin-top:10px}td,th{border:1px solid #e5e7eb;padding:8px 12px;text-align:left}th{background:#f1f5f9;font-weight:600;color:#374151}.header{display:flex;justify-content:space-between;align-items:center;margin-bottom:20px}.company{font-size:20px;font-weight:700;color:#1E40AF}.footer{margin-top:40px;border-top:1px solid #e5e7eb;padding-top:16px;font-size:11px;color:#6b7280;text-align:center}.sign-area{display:flex;justify-content:space-between;margin-top:60px}.sign-box{text-align:center;width:200px}.sign-line{border-top:1px solid #374151;padding-top:8px;font-size:11px;color:#6b7280}</style></head><body><div class="header"><div><div class="company">🏦 Dada Finance & Corporation</div><div style="color:#6b7280;font-size:11px">Finance & Corporation</div></div><div style="text-align:right;font-size:11px;color:#6b7280">Date: ${date}<br/>Loan No: ${loan.loanNo}</div></div>`
