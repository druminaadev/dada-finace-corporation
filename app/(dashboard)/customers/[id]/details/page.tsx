...
function DocumentsPanel() {
  ...
  const handleFile = (docName: string, file: File | undefined | null) => {
    ...
    if (!validation.valid) { showToast(validation.error || 'Invalid file', 'error'); return }
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-2 mt-2">
                        {confirmed[doc] ? (
                          ...
                          <button
                            onClick={() => { setConfirmed(p => ({ ...p, [doc]: true })); showToast(`${file.name} confirmed`, 'success') }}
      ...
      <div className="flex justify-end pt-2">
        <Button
          onClick={() => {
            ...
            if (!uploaded.length) { showToast('No documents to save', 'error'); return }
