  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {selectedLoan && selectedCustomer ? (
        <div className="flex items-center justify-between gap-3 rounded-lg border border-[var(--primary)]/20 bg-[var(--background)] px-3 py-2.5 dark:border-[var(--secondary)]/30 dark:bg-[var(--primary)]/20">
        ...
        <>
          <div className="relative">
            ...
            <input
              ...
              className="h-11 w-full rounded-xl border border-slate-300 bg-white pl-9 pr-3 text-sm text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/20 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100"
            />
          </div>
            ...
            {filteredLoans.length === 0 ? (
              ...
              filteredLoans.map(({ loan, customer }) => (
                <button
                  ...
                  className="flex w-full items-center justify-between gap-3 border-b border-slate-100 px-3 py-2.5 text-left transition-colors last:border-b-0 hover:bg-[var(--background)] dark:border-slate-700 dark:hover:bg-[var(--primary)]/20"
                >
