...
const masterItems = [
  { label: 'States', path: '/master/states', icon: MapPin, description: 'Manage states', color: '#462C7D' },
  { label: 'Cities', path: '/master/cities', icon: Building2, description: 'Manage cities', color: '#831C91' },
  { label: 'Areas', path: '/master/areas', icon: MapPin, description: 'Manage areas', color: '#D552A3' },
  { label: 'Branches', path: '/master/branches', icon: Landmark, description: 'Manage branches', color: '#462C7D' },
  { label: 'Loan Types', path: '/master/loan-types', icon: Tag, description: 'Manage loan types', color: '#831C91' },
  { label: 'Banks', path: '/master/banks', icon: Landmark, description: 'Manage banks', color: '#D552A3' },
]
