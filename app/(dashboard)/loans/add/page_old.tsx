...
export default function AddLoanPage() {
  ...
  const sectionHeader = (
    ...
    <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[var(--secondary)]/30 dark:border-[var(--border)]">
      <div className="w-10 h-10 rounded-lg flex items-center justify-center shadow-sm ring-2 ring-[var(--secondary)]/20 dark:ring-[var(--border)]" style={{ background }}>
  ...
  const personSupportFields = (prefix: 'nominee' | 'guarantor1' | 'guarantor2', ageValue: string | undefined) => (
    <>
      ...
      <div className="mt-4 pt-4 border-t border-[var(--secondary)]/20 dark:border-[var(--border)]">
  ...
  return (
    <div className="min-h-screen pb-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        <div className="rounded-xl border border-[var(--secondary)]/30 bg-white p-3 shadow-sm dark:border-[var(--border)] dark:bg-[var(--card)]">
            ...
            {STEPS.map((step, index) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: '#FFFFFF',
                    border: `1.5px solid ${isActive ? 'var(--primary)' : isComplete ? 'var(--primary-light)' : 'var(--secondary)'}`,
                    color: isActive || isComplete ? 'var(--primary)' : 'var(--primary-light)',
                  }}
                >
                  <span
                    style={{
                      background: isActive || isComplete ? 'rgba(70, 44, 125, 0.1)' : 'var(--background)',
                      color: 'var(--primary)',
                    }}
        ...
        {currentStep === 1 && (
          <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
            {sectionHeader(<BadgeCheck size={18} />, 'Aadhaar Authentication', 'Aadhaar details and verification document', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
        ...
        {currentStep === 2 && (
          <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
            {sectionHeader(<User size={18} />, 'Personal Details', 'Customer personal and contact information', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div className="mt-3 flex flex-col gap-2">
              ...
              <div className="flex flex-wrap items-center gap-3 rounded-lg border border-dashed border-[var(--secondary)]/50 bg-[var(--background)]/40 p-3 dark:border-[var(--border)] dark:bg-[var(--card)]">
                {profilePhoto && (
                ...
                <label className="cursor-pointer px-4 py-2 rounded-xl font-semibold text-sm transition-all shadow-sm hover:shadow-md" style={{ background: 'linear-gradient(135deg, var(--primary), var(--primary-light))', color: '#fff' }}>
        ...
        {currentStep === 3 && (
          <>
            <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
              {sectionHeader(<FileText size={18} />, 'Loan Information', 'Basic loan schedule and type', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
              {sectionHeader(<FileText size={18} />, 'Bank Details', 'Customer bank account information', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
              {sectionHeader(<Calculator size={18} />, 'Financial Details', 'Loan amount, interest, and payment terms', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="h-11 px-4 flex items-center text-sm rounded-xl font-bold" style={{ background: 'linear-gradient(135deg, rgba(70, 44, 125, 0.1), rgba(131, 28, 145, 0.15))', color: 'var(--primary)', border: '1.5px solid rgba(70, 44, 125, 0.3)' }}>
                    {formatINR(interestAmount)}
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4 pt-4 border-t border-[var(--secondary)]/30 dark:border-[var(--border)]">
                <div className="rounded-xl p-4 shadow-sm" style={{ background: 'linear-gradient(135deg, var(--background), #F8F4F6)', border: '1.5px solid var(--secondary)' }}>
                  <p className="text-xs font-semibold" style={{ color: 'var(--primary)' }}>Principal Amount</p>
                  <p className="text-xl font-bold mt-1" style={{ color: 'var(--primary)' }}>{formatINR(Number(watchAmount || 0))}</p>
                </div>
                <div className="rounded-xl p-4 shadow-sm" style={{ background: 'linear-gradient(135deg, #F8F4F6, #F0E6ED)', border: '1.5px solid var(--primary-light)' }}>
                  <p className="text-xs font-semibold" style={{ color: 'var(--primary-light)' }}>Total Interest</p>
                  <p className="text-xl font-bold mt-1" style={{ color: 'var(--primary-light)' }}>{formatINR(interestAmount)}</p>
                </div>
            ...
            <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
              {sectionHeader(<Shield size={18} />, 'Security Deposit', 'Collateral details for the loan', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-4 rounded-lg bg-[var(--background)] p-2 dark:bg-[var(--card)]">
                {(['vehicle', 'gold'] as const).map(t => (
                  <button
                    ...
                    style={{
                      background: securityType === t ? 'linear-gradient(135deg, var(--primary), var(--primary-light))' : '#FFFFFF',
                      color: securityType === t ? '#fff' : '#111111',
                      border: `1.5px solid ${securityType === t ? 'var(--primary)' : '#FFFFFF'}`,
                    }}
                  >
                      ...
                      <div className="flex gap-3 h-11">
                        {['yes', 'no'].map(v => (
                          <label key={v} className="flex-1 flex items-center justify-center gap-2 text-sm font-semibold cursor-pointer rounded-xl transition-all" style={{
                            background: watchRcReceived === v ? 'linear-gradient(135deg, var(--primary), var(--primary-light))' : '#FFFFFF',
                            color: watchRcReceived === v ? '#FFFFFF' : '#6B6B6B',
                            border: `1.5px solid ${watchRcReceived === v ? 'var(--primary)' : 'var(--secondary)'}`,
                          }}>
            ...
            <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
              {sectionHeader(<User size={18} />, 'Receiver Customer Details', 'Person receiving the loan amount', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        {currentStep === 4 && (
          <>
            <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
              {sectionHeader(<UserCheck size={18} />, 'Nominee Details', 'Nominee information for the loan', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
            ...
            <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
              {sectionHeader(<Users size={18} />, 'Guarantor 1 Details', 'Primary guarantor information', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
            ...
            <NeumorphicCard className="rounded-xl border-[var(--secondary)]/30 bg-white/95 p-5">
              {sectionHeader(<Users size={18} />, 'Guarantor 2 Details', 'Secondary guarantor information', 'linear-gradient(135deg, var(--primary), var(--primary-light))')}
        ...
        <div className="flex flex-wrap items-center justify-end gap-3 rounded-xl border border-[var(--secondary)]/30 bg-white px-4 py-3 shadow-sm dark:border-[var(--border)] dark:bg-[var(--card)]">
