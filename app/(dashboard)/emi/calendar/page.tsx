        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-4 shadow-sm">
          <div className="flex items-center justify-between gap-3 mb-4">
            ...
            <div className="text-center">
              ...
              <button onClick={() => setCurrentMonth(new Date())} className="text-xs font-semibold text-[var(--primary)] dark:text-[var(--secondary)] mt-1">Today</button>
            </div>
            <button
              onClick={nextMonth}
              className="p-2 rounded-lg border border-slate-200 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700 cursor-pointer text-slate-700 dark:text-slate-300 transition-colors"
              ...
              return (
                <div
                  ...
                  className={`min-h-24 rounded-lg p-2 border transition-all ${
                    isToday
                      ? 'border-[var(--primary)] bg-[var(--background)] dark:bg-[var(--primary)]/20 ring-2 ring-[var(--primary)]/20'
                      : 'border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50'
                  }`}
                >
                  <div className="flex items-center justify-between gap-1 mb-2">
                    <span className={`text-xs font-bold ${isToday ? 'text-[var(--primary)] dark:text-[var(--secondary)]' : 'text-slate-600 dark:text-slate-400'}`}>
                      {format(day, 'd')}
                    </span>
