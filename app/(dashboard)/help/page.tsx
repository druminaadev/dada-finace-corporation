...
const quickLinks = [
  { icon: Book, label: 'Documentation', description: 'Complete user guide', color: 'var(--primary)' },
  { icon: Video, label: 'Video Tutorials', description: 'Step-by-step videos', color: 'var(--primary-light)' },
  { icon: FileText, label: 'Release Notes', description: 'Latest updates', color: 'var(--secondary)' },
  { icon: Users, label: 'Community', description: 'Join discussions', color: 'var(--primary)' },
]
      ...
      <div className="max-w-2xl mx-auto">
        <div className="relative">
          ...
          <input
            ...
            style={{
              borderColor: searchQuery ? 'var(--primary)' : '#e2e8f0',
